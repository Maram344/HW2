...
1.  How many observations and how many variables are in the dataset? Use
    ...
    represent? observation:953 variables:26
...
filter(category %in% c("Physics","Medicine", "Chemistry",
"Economics"))
```
...
born_country_us = if_else(born_country == "USA","USA","Other"))
 nobel_living_science %>%ggplot(aes(x = country_us,y=born_country_us, fill = category)) + geom_bar(stat = "identity", position = "dodge",
orientation = "horizontal")
```
